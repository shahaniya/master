	...
	<tbody id="kannouncement_body">
		...
		<tr class="krow1">
			...
			<td colspan="4" class="kcol krowmoderation">
				...
				<button type="submit" name="kcheckgo" onClick="Joomla.submitbutton()" class="btn btn-primary" value="<?php echo JText::_('COM_KUNENA_GO') ?>" ><?php echo JText::_('COM_KUNENA_GO') ?></button>
			</td>
			<?php endif; ?>
		</tr>
		<!-- /Bulk Actions -->
