...
<div class="kblock kreport">
	<div class="kheader">
		<h3><span><?php echo JText::_('COM_KUNENA_REPORT_TO_MODERATOR') ?></span></h3>
	</div>
		...
		<div class="kbody">
			<div id="kreport-container">
				<form method="post" action="<?php echo KunenaRoute::_('index.php?option=com_kunena') ?>" class="kform-report">
					...
					<button class="btn btn-primary ks" type="submit" name="Submit" value="<?php echo JText::_('COM_KUNENA_REPORT_SEND') ?>"><?php echo JText::_('COM_KUNENA_REPORT_SEND') ?></button>
					<button class="btn btn-primary ks" onclick="history.back()" type="button" name="button" value="<?php echo JText::_('COM_KUNENA_BACK') ?>"><?php echo JText::_('COM_KUNENA_BACK') ?></button>
				</form>
			</div>
		</div>
	</div>
