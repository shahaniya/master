...
<div class="kblock">
	<div class="kheader">
		<h3><span><?php echo !isset($this->message) ? JText::_('COM_KUNENA_TITLE_MODERATE_TOPIC') : JText::_('COM_KUNENA_TITLE_MODERATE_MESSAGE'); ?></span></h3>
	</div>
...
<?php endif; ?>
				...
				<div>
					<button type="submit" class="btn btn-primary" value="<?php echo JText::_ ( 'COM_KUNENA_POST_MODERATION_PROCEED' ); ?>"><?php echo JText::_ ( 'COM_KUNENA_POST_MODERATION_PROCEED' ); ?></button>
					<a href="javascript:window.history.back();" class="btn btn-primary" ><span class=""><?php echo JText::_ ( 'COM_KUNENA_BACK' ); ?></span></a>
				</div>
			</form>
		</div>
	</div>
