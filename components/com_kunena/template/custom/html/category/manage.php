	...
	<table class="kadmin-sort">
		<tr>
			<td class="kleft">
				...
				<button class="btn btn-primary" onclick="this.form.submit();"><?php echo JText::_( 'COM_KUNENA_GO' ); ?></button>
				<button class="btn btn-primary" onclick="document.getElementById('search').value='';this.form.submit();"><?php echo JText::_( 'COM_KUNENA_RESET' ); ?></button>
			</td>
			<td class="kright">
				<button class="btn btn-primary" onclick="submitbutton('add')"><?php echo JText::_( 'COM_KUNENA_NEW' ); ?></button>
				<button class="btn btn-primary" onclick="submitbutton('edit')"><?php echo JText::_( 'COM_KUNENA_EDIT' ); ?></button>
				<button class="btn btn-primary" onclick="submitbutton('remove')"><?php echo JText::_( 'COM_KUNENA_DELETE' ); ?></button>
			</td>
		</tr>
	</table>
