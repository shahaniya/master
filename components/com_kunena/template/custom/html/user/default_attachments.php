...
<div class="kblock">
<div class="kheader">
	<h3><span><?php echo $this->title;?></span></h3>
</div>
	<div class="kcontainer">
		<div class="kbody">
			<form action="<?php echo KunenaRoute::_('index.php?option=com_kunena') ?>" method="post" id="adminForm" name="adminForm">
				...
				<button class="btn btn-primary" type="submit" value="<?php echo JText::_('COM_KUNENA_FILES_DELETE') ?>" style="float:right;"><?php echo JText::_('COM_KUNENA_FILES_DELETE') ?></button>
			</form>
		</div>
	</div>
</div>
