...
<div class="kblock">
	<div class="kheader">
		<h3><span><?php echo $this->banInfo->id ? JText::_('COM_KUNENA_BAN_EDIT') : JText::_('COM_KUNENA_BAN_NEW' ); ?></span></h3>
	</div>
			...
			<table id="kaddban">
				...
				<tr class="krow<?php echo ($i^=1)+1;?>">
					<td class="kcol-addban-center" style="text-align:center;" colspan="2">
						<button class="btn btn-primary ks" type="submit" value="<?php echo $this->banInfo->id ? JText::_('COM_KUNENA_BAN_EDIT') : JText::_('COM_KUNENA_BAN_NEW' ); ?>" name="Submit"><?php echo $this->banInfo->id ? JText::_('COM_KUNENA_BAN_EDIT') : JText::_('COM_KUNENA_BAN_NEW' ); ?></button>
					</td>
				</tr>
				</tbody>
			</table>
