...
<?php endif; ?> 
<ul class="sf-menu <?php echo $class_sfx;?> <?php echo $layout_class; ?><?php if($params->get('enableSticky')) : ?> sticky<?php endif; ?>" id="module-<?php echo $module->id; ?>">
<?php
